...
<main class="container d-flex flex-column align-items-center justify-content-center">
    <section class="row d-flex flex-column justify-content-around my-5">
        ...
        <div class="d-flex justify-content-between align-items-start">
            ...
            <?php
            the_title('<h2 class="col-8 col-lg-8 font-weight-light mb-5 mb-md-0 float-left">','</h2>');
            $date = get_field('date', false, false);
            $date = new DateTime($date); ?>

            <h3 class="col-4 col-lg-4 text-right"><?=$date->format('d/m/Y'); ?></h3>
        </div>
        <div class="col-12 card flex-column flex-lg-row px-0 flex-lg-wrap text-white border-0">
            ...
            <img src="<?php the_field('ajouter_une_image'); ?>" alt="..." class="card-img-top img-fluid d-block h-100 col-12 col-lg-6 px-0 pl-lg-2 ">
        ...
        <ul class="list-group col-lg-12 d-flex flex-row justify-content-between pr-0 mt-5 bg-white">
            <li class="list-group-item border-0 bg-none"><?php previous_post_link('%link','%title','événement',TRUE); ?></li>
            <li class="list-group-item border-0 bg-none"><?php next_post_link('%link','%title','événement',TRUE); ?></li>
        </ul>
