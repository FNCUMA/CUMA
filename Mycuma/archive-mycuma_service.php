...
<main id="Services" class="container">
    <h1 class="font-weight-light col-12 pl-lg-5 my-5 text-lg-left text-center">nos services</h1>
    <section class="row justify-content-center">
        <ul class="services p-0 list-unstyled justify-content-lg-between align-content-lg-between col-lg-12 mb-5 d-flex flex-wrap flex-row pr-0 shadow-lg h-100 p-lg-5">
            ...
            <li class="border-0 col-12 mt-lg-4 mb-lg-0 mb-5 col-lg-4">
                <a class="text-dark d-flex flex-column align-items-lg-center justify-content-lg-between" href="<?= get_permalink($post); ?>">
                    <h2 class="font-weight-light text-lg-left text-center"><?php the_title(); ?></h2>
