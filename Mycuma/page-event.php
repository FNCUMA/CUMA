...
<main class="container">
    ...
    <section class="row justify-content-center mt-lg-5">
        <ul class="list-unstyled col-lg-12 d-flex justify-content-lg-between flex-lg-wrap flex-column flex-lg-row mt-3 mt-lg-0 px-0 h-100">
<?php
    ...
    while( $event_query->have_posts()): $event_query->the_post(); ?>
            ...
            <li class="col-12 col-lg-4 h-100 mb-5">
                <a class="text-dark d-flex align-items-center justify-content-center" href="<?=get_permalink($post); ?>">
                    ...
                    <?php
                        ...
                        <img class="img-fluid d-block w-100 card-img-top" src="<?=$thumbnail_src; ?>" alt="..." />
    ...
    <nav class="pagination mt-5 mb-md-2 mt-md-0 mx-auto">
