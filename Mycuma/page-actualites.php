...
<main class="container">
    <h1 class="font-weight-light col-12 pl-lg-5 mt-5 mt-lg-3 text-lg-left text-center">Actualités</h1>

    <?php get_template_part('slider','actualites'); ?>

    <section class="row justify-content-center mt-lg-5">
        <ul class="Actu list-unstyled col-lg-12 d-flex justify-content-lg-between flex-lg-wrap flex-column flex-lg-row mt-lg-0 px-0 h-100">
        ...
        <?php
            ...
            <li class="col-12 col-lg-4 mb-5">
                ...
                $thumbnail_src = $thumbnail_html[0]; ?>
                        ...
                        <img class="img-fluid d-block w-100 card-img-top px-0" src="<?=$thumbnail_src; ?>" alt="..." />
    ...
    <?php endif; ?>
        ...
        <nav class="pagination mt-5 mt-md-0 mb-md-2 mx-auto">
